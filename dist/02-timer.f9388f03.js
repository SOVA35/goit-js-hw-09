...
const timer = {
    ...
    start () {
        intervalId = setInterval(()=>{
            ...
            this.rootSelector.querySelector("[data-days]").textContent = this.addingZero(days);
            this.rootSelector.querySelector("[data-hours]").textContent = this.addingZero(hours);
            this.rootSelector.querySelector("[data-minutes]").textContent = this.addingZero(minutes);
            this.rootSelector.querySelector("[data-seconds]").textContent = this.addingZero(seconds);
    ...
    convertMs (ms) {
        ...
        const seconds = this.addingZero(Math.floor(ms % day % hour % minute / second));
        return {
            days,
            hours,
            minutes,
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","flatpickr/dist/themes/dark.css":"lRCCN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eVN6V":[function() {},{}],"lRCCN":[function() {},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequired7c6")
